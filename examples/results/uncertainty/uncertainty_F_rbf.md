# 不确定度校准报告：uncertainty_F_rbf

- 生成时间（UTC）: 2026-09-01T10:30:00+00:00
- 数据目录: dist\data | 等级: F | 模型: rbf | 样本数: 120 | k: 3
- 样本平均误差（Smoothed ROI MAE）: 0.0018

## Spearman 秩相关（估计值 vs 实际误差）

- knn_distance（排序口径）: 0.0619
- residual_knn（同量纲）: 0.7894
...
可靠性曲线: uncertainty_F_rbf_reliability.png
